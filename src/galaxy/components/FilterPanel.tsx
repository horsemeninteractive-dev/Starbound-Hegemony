...
const STAR_ORDER: StarType[] = ["O", "B", "A", "F", "G", "K", "M", "whitedwarf", "neutron", "pulsar", "binary", "trinary", "blackhole", "whitehole", "magnetar", "protostar", "dyson_swarm"];
const LAYER_ORDER: { key: DisplayLayer; label: string; views?: string[] }[] = [
  ...
  { key: "objectLabels",  label: "Object Labels",   views: ["galaxy", "system", "body"] },
